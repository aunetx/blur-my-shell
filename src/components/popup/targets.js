const POPUP_STYLE_CLASSES = ['popup-menu', 'candidate-popup-boxpointer'];
const POPUP_TARGET_STYLE_CLASSES = ['popup-menu-content', 'quick-settings', 'notification-banner', 'candidate-popup-content','screenshot-ui-panel'];
