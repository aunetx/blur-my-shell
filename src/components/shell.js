...
const SHELL_INTERNAL_STYLE_CLASSES = ['bms-shell-blurred-widget', 'bms-shell-backgroundgroup'];
const SHELL_INTERNAL_NAMES = ['bms-shell-blurred-widget', 'bms-shell-backgroundgroup'];
